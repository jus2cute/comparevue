...
1. **Default to async.** Write updates. Record Loom videos instead of scheduling calls. Assume your teammates are reading your updates 6 hours later.

2. **Set working hours in your PM tool.** If your tool supports it (ClickUp, Linear do; Asana, Monday don't fully), use it. If not, agree on a team norm: no one is expected to respond outside 9am-6pm their time.

3. **One source of truth.** Don't let decisions made in Slack or Zoom live only there. Sync them back to your PM tool. "If it's not in the board, it didn't happen" is a good remote-team mantra.
